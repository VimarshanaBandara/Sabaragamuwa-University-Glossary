...
import 'package:glossary/screens/mainUnionMessage.dart';
            ...
            children: [
              ...
              ListTile(
                ...
                title: Align(
                  ...
                  child: Column(
                    children: [
                      Text('Main Students Union ',style: TextStyle(fontSize: 18.0),textAlign: TextAlign.center),
                      Text('Sabragamuwa University of Sri Lanka ',textAlign: TextAlign.center,style: TextStyle(fontSize: 18.0),),
                    ],
                  ),
                ),
                onTap: (){
                 Navigator.push(context, MaterialPageRoute(builder: (context)=>MainUnionMessage()));
                },
              )
